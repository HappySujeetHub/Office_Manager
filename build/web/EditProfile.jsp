<%-- 
    ...
    Created on : 4 Mar, 2024, 11:29:31 PM
    Author     : Sujeet's PC
--%>
...
<html>
    ...
    <body>
    <center>
        <span style="font-size: 30px; color: lightcoral; font-style: normal">Edit Profile</span>
            ...
            if(db.rst.next())
                    {
                        ...
                        out.println("<table width='600' border='1' cellsacing=0 cellpadding='10' bgcolor=lightyellow>");
                        out.println("<tr><td width='300'>Employee Code</td><td><input type='number' name='code' value="+db.rst.getString(1)+" ></td></tr>");
